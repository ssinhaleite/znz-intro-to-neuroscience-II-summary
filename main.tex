...
which in turn makes relapse more likely. Disrupted PFC function is crucial for
this stage.
...
There are three classes of drugs according to their mechanism of action.
...
projection (VTA - ventral tegmental area to NAcc - Nucleus Accumbens), ii)
...
subjective feelings of pleasure. But, when the reward is predicted but doesn't
...
Note: this answers were provided by students and were not verified by a
teacher. Use them at your own risk.
...
\item \paragraph{Phantom limb. Some reasons about phantom limb in congenital deficience. Similarities with xenomelia. Are you in favor of the amputation of a healthy limb in case of xenomelia? Defend your oppinion.}

\item \paragraph{Emotion. What are the five ways to study emotions? Which of those ways are studied only in humans? Which one is less studied in humans? What is the typical approach to study anxiety in rodents? 3 paradigms and 3 findings.}

\item \paragraph{Describe the role of dopamine in value learning}

\item \paragraph{Medial Temporal Lobe Epilepsy: symptoms, deficiencies and affected (sub)processes areas. Bonus question: Who was H.M? And why he became famous?}

\item \paragraph{Romberg test. What are the systems related? Brain areas? What are the periferal and central systems? Why, in some cases, we would like to sharpen the test by doing it in a foam? }
...
\item \paragraph{Explain what is supernumerary and negative phantom limbs.}
supernumerary is a condition where the individuo believes and receives sensory
...
One tool used in neurosurgery is the fMRI, which is based on neurovascular
coupling. However, in some cases (brain tumor, for instance) this coupling
doesn't hold and then, new techniques are necessary.
The respiract for instance, is a tool that controls the amount of
CO\textsubscript{2} consumed, and thus, is able to measure vascular reactivity.
