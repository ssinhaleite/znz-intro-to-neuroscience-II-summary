...
To induce the whole-body phantom we can use the out-of-body experience: observe the own body in front of oneself (for example, using a head mountad display) and simultaneously touch the real and fake bodies. After a while, the participant will felt that he/her is at the place of seen touch.
\end{enumerate}
